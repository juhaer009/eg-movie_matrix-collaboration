...
import { clearError, googleLogin, loginUser } from "@/redux/feature/authSlice";
    ...
    <div className="flex min-h-screen bg-white">
          ...
          <div className="mt-auto">
            ...
            >
              ...
              <h1 className="text-5xl font-bold leading-tight">
                ...
                <span className="text-indigo-400">
                  Your Entertenment World.
                </span>
              </h1>
              <p className="mt-6 text-lg text-slate-300 max-w-md">
                Enter your credentials to access your dashboard, projects, and
                team settings.
              </p>
            </motion.div>
            ...
            <div className="mt-12 flex items-center gap-6 border-t border-white/10 pt-8">
              <div className="flex items-center gap-2">
                ...
                <p className="text-xs text-slate-400 uppercase tracking-tight font-semibold">
                  MFA Enabled
                </p>
              </div>
              <div className="flex items-center gap-2">
      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-32">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <div 
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 cursor-pointer text-slate-500 hover:text-slate-900 transition-colors"
                  >
        ...
        2.84c.87-2.6 3.3-4.53 6.16-4.53z"
              ...
              {/* <Button
                variant="outline"
                className="h-11 border-slate-200 hover:bg-slate-200 transition-colors"
              >
